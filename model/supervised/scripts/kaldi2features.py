...
def lattice2features(phones_file, post_file, out_file, out_phones_file, word_position_dependent=True):
    """
...
if __name__ == '__main__':
    ...
    parser.add_argument('out_phones_file')
    args = parser.parse_args()
    lattice2features(args.phones_file, args.post_file, args.out_file, args.out_phones_file)
